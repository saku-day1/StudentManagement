...
VALUES ('山田 太郎', 'ヤマダ タロウ', 'たろう', 'taro.yamada@example.com', '東京都', 25, '男性', '', 0),
...
VALUES (1, 'Javaコース', '2026-04-01 00:00:00', '2027-04-01 00:00:00'),
       ...
       (6, 'Javaコース', '2026-04-25 00:00:00', '2027-04-25 00:00:00');

INSERT INTO application_status (student_course_id, status, is_deleted, deleted_at)
VALUES
    -- 6か月より古い削除済み：物理削除される想定
    (1, '仮申込', true, '2025-09-01 00:00:00'),

    -- 6か月以内の削除済み：残る想定
    (2, '本申込', true, '2026-02-01 00:00:00'),
    ...
    -- 6か月より古い削除済み：物理削除される想定
    (5, '本申込', true, '2025-08-01 00:00:00');